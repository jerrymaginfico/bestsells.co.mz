...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Lista de Blusas');?></title>
  <link rel="shortcut icon" href="<?php echo base_url();?>bestsells/img/bestlogo.png">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Lista de Blusas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
             ...
             <div class="card-header">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        <select class="custom-select" id="listing_type" name="listing_type" style="width: 100%;" required>
                          ...
                          <option value="camisas femeninas" selected><?php echo get_phrase('Camisas Femeninas');?></option>
                        </select>
                      </div>
                    </div>
                    <div class="col-sm-9">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php if(count($blusa)):?>
                      <?php foreach($blusa as $blusa):?>
                  <tr>
                    <td><?=$blusa->wshirt_title;?></td>
                    <td><?=$blusa->product_status;?></td>
                    <td><?=number_format($blusa->product_price);?></td>
                    <td><?=$blusa->data_cadastro;?></td>
                    <td>
                      <center>
                      <a href="<?=base_url('Vendedor/Editar_Blusas/'.$blusa->wshirt_id);?>" title="Editar Dados" class="btn btn-info btn-circle btn-sm"><i class="fa fa-edit"></i></a>
                      <a href="<?=base_url('Vendedor/Change_Wshirt_Status/'.$blusa->wshirt_id);?>" class="btn btn-warning btn-circle btn-sm" title="Editar Estado"><i class="fa fa-ban"></i></a>
                      <a href="<?=base_url('Vendedor/Eliminar_blusas/'.$blusa->wshirt_id);?>" title="Remover Produto" class="btn btn-danger btn-circle btn-sm text-white"><i class="fa fa-times"></i></a>
                      </center>
                    </td>
                  </tr>
                <?php endforeach;
