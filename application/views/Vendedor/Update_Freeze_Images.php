  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <li><a href="#"><?=$freeze->freeze_categoria;?></a></li>
            <li><a href="#">Atualizar Imagens</a></li>
            <li><a href="#"><?=$freeze->freeze_title;?></a></li>
            </ul>
          </div>
        </div>
        <!-- /row -->
    ...
    <div class="section">
            ...
            <div id="product-main-img">
              <div class="product-preview">
                <?php if($freeze->image_one == ""):?>
                          ...
                          <?php else: ?>
                          <img src="<?= base_url().'DomesticImages/'.$freeze->image_one;?>" class="product-image" alt="Product Image">
                        <?php endif;?>
              </div>

              <div class="product-preview">
              <?php if($freeze->image_two == ""):?>
                         <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
                          <?php else: ?>
                        <img src="<?= base_url().'DomesticImages/'.$freeze->image_two;?>" class="product-image" alt="Product Image">
                        <?php endif;?>
              </div>

              <div class="product-preview">
              <?php if($freeze->image_three == ""):?>
                          <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
                          <?php else: ?>
                        <img src="<?= base_url().'DomesticImages/'.$freeze->image_three;?>" class="product-image" alt="Product Image">
                      <?php endif;?>
              </div>

              <div class="product-preview">
                <?php if($freeze->image_four == ""):?>
                          <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
                          <?php else: ?>
                        <img src="<?= base_url().'DomesticImages/'.$freeze->image_four;?>" class="product-image" alt="Product Image">
                        <?php endif;?>
              </div>
            </div>
          </div>
      ...
      <div class="card-footer">
              <?=form_open_multipart('Vendedor/freeze_image_update/'.$freeze->freeze_id);?>
