  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- SELECT2 EXAMPLE -->
        <div class="card card-header-pills card-primary">
          <div class="card-header">
            <h3 class="card-title"><?php echo get_phrase('Actualizar Dados do Produto');?></h3>
          ...
          <!-- /.card-header -->
          <?=form_open('Vendedor/Update_Produto/'.$cars->part_id);?>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label><?php echo get_phrase('Titulo do Produto');?></label>
                  <input type="text" name="update_title" id="update_title" value="<?=$cars->part_title;?>"class="form-control" required>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label><?php echo get_phrase('Modelo do Carro');?></label>
                  <input type="text" name="update_modelo" id="update_modelo" value="<?=$cars->part_modelo;?>" class="form-control" required>
                </div>
                <!-- /.form-group -->

                <div class="form-group">
                  <label><?php echo get_phrase('Quilometragem');?></label>
                  <input type="text" name="update_quilometragem" id="update_quilometragem" value="<?=$cars->part_quilometragem;?>" class="form-control" required>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Ano');?></label>
                  <input type="text" name="update_ano" id="update_ano" value="<?=$cars->part_ano;?>" class="form-control" required>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Tipo de Carro');?></label>
                  <input type="text" name="update_tipo" id="update_tipo" value="<?=$cars->part_tipocarro;?>" class="form-control" required>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Preco');?></label>
                  <input type="text" name="update_preco" id="update_preco" value="<?=number_format($cars->product_price);?>" class="form-control" required>
                </div>
              ...
              <div class="col-md-6">
                ...
                <!-- /.form-group -->
                <div class="form-group">
                  <label><?php echo get_phrase('Cor do Carro');?></label>
                  <input type="text" name="update_cor" id="update_cor" value="<?=$cars->part_cor;?>" class="form-control" required>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Tipo de Combustivel');?></label>
                  <input type="text" name="update_combustivel" id="update_combustivel" value="<?=$cars->part_combustivel;?>" class="form-control" required>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Transmissao');?></label>
                  <input type="text" name="update_transmissao" id="update_transmissao" value="<?=$cars->part_transmissao;?>" class="form-control" required>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Descricao');?></label>
                  <textarea rows="3" class="form-control" name="update_descricao" id="update_descricao" required><?=$cars->part_descricao;?></textarea>  
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-primary" id="update_car" name="update_car"><?php echo get_phrase('Gravar Dados');?></button>
            <a href="<?php echo base_url('Vendedor/Update_product_images/'.$cars->part_id);?>" class="btn btn-dark"><?php echo get_phrase('Actualizar Imagens');?></a>
          </div>
          <?=form_close();?>
