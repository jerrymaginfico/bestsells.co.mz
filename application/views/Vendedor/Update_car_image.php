	...
	<body>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#"><?=$cars->car_categoria;?></a></li>
						<li><a href="#">Actualizar Imagens</a></li>
						<li><a href="#"><?=$cars->part_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
		...
		<div class="section">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							<div class="product-preview">
								<?php if($cars->image_one == ""):?>
				                  <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
				                  <?php else: ?>
				                	<img src="<?= base_url().'CarrsImages/'.$cars->image_one;?>" class="product-image" alt="Product Image">
				                <?php endif;?>
							</div>

							<div class="product-preview">
							<?php if($cars->image_two == ""):?>
				                 <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
				                  <?php else: ?>
				                <img src="<?= base_url().'CarrsImages/'.$cars->image_two;?>" class="product-image" alt="Product Image">
				                <?php endif;?>
							</div>

							<div class="product-preview">
							<?php if($cars->image_three == ""):?>
                  				<img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
                  				<?php else: ?>
                				<img src="<?= base_url().'CarrsImages/'.$cars->image_three;?>" class="product-image" alt="Product Image">
                			<?php endif;?>
							</div>

							<div class="product-preview">
								<?php if($cars->image_four == ""):?>
				                  <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
				                  <?php else: ?>
				                <img src="<?= base_url().'CarrsImages/'.$cars->image_four;?>" class="product-image" alt="Product Image">
				                <?php endif;?>
							</div>
						</div>
					</div>
			...
			<div class="card-footer">
	            <?=form_open_multipart('Vendedor/car_image_update/'.$cars->part_id);?>
	            <h6><?php echo get_phrase('Actualizar Imagens (4)');?></h6>
	            <br>
	            <h6 style="font-size: 14px;font-weight: 500;"><?php echo get_phrase('Imagens do Carro');?></h6>
