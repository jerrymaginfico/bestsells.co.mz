...
<head>
  ...
  <title><?php echo get_phrase('Best$ells | Eliminar do Produto');?></title>
        ...
        <!-- general form elements -->
            <div class="card card-danger">
              <div class="card-header">
               <h3 class="card-title"><?php echo get_phrase('Eliminar Produto Com ID:');?> <?=$mobile->cel_id;?></h3>
             </div>
             <?=form_open('Vendedor/remove_mobile/'.$mobile->cel_id);?>
              <!-- /.card-header -->
              <!-- form start -->
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="cel_title" id="cel_title" value="<?=$mobile->cel_title;?>" readonly>
                  </div>
                  </td>
                  <td>
                    <div class="form-group">
                ...
                <tr>
                  <td style="border-top: none;">
                    ...
                    <input type="text" class="form-control" name="cel_modelo" id="cel_modelo" value="<?=$mobile->cel_modelo;?>" readonly>
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                ...
                <tr>
                  <td style="border-top: none;">
                    ...
                    <input type="text" class="form-control" name="cel_cards" id="cel_cards" value="<?=$mobile->cel_cards;?>" readonly>
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="cel_processor"><?php echo get_phrase('Processador');?></label>
                    <input type="text" class="form-control" name="cel_processor" id="cel_processor" value="<?=$mobile->cel_processor?>" readonly>
                  </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="border-top: none;">
                    ...
                    <input type="text" class="form-control" name="cel_battery_size" id="cel_battery_size" value="<?=$mobile->cel_battery_size;?>" readonly>
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="cel_camera"><?php echo get_phrase('Camera Traseira + Frontal');?></label>
                    <input type="text" class="form-control" name="cel_camera" id="cel_camera" value="<?=$mobile->cel_camera;?>" readonly>
                  </div>
                  </td>
                </tr>
                <tr>
                  <td style="border-top: none;">
                    ...
                    <textarea class="form-control" rows="3" name="cel_descricao" id="cel_descricao" readonly><?=$mobile->cel_descricao;?></textarea>
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                      <label for="product_price"><?php echo get_phrase('Preço do Produto');?></label>
                      <input type="text" name="product_price" id="product_price" class="form-control" value="<?=$mobile->product_price;?>" readonly>
                    </div>
                  </td>
                </tr>
              </table>
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-outline-danger" id="remove_mobile" name="remove_mobile"><?php echo get_phrase('Eliminar Produto');?></button>
          </div>
          <?=form_close();?>
