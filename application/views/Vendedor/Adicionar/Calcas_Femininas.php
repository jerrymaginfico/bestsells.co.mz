...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Adicionar Calças Femeninas');?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Calças Femininas');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    <label for="calc_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="calc_title" id="calc_title" placeholder="Nome do Produto">
                  </div>
                  </td>
                  <td>
                    <div class="form-group">
                    <label for="calc_size"><?php echo get_phrase('Tamanho');?></label>
                    <input type="text" class="form-control" name="calc_size" id="calc_size" placeholder="Tamanho do Produto">
                  </div>
                 </td>
                </tr>
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="calc_descricao"><?php echo get_phrase('Descrição');?></label>
                    <textarea class="form-control" rows="3" name="calc_descricao" id="calc_descricao" placeholder="Informaçao Adicional..."></textarea>
                  </div>
                  </td>
                   <td style="border-top: none;">
                   <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="btnSave_Wtrouser" id="btnSave_Wtrouser" class="btn btn-primary"><?php echo get_phrase('Salvar & Continuar');?></button>
  ...
  $(function(){
   ...
   /*$('.modal').modal({
    ...
    //Modal Show Script End
      ...
      $('#btnSave_Wtrouser').click(function(){
        var calc_title     = $('#calc_title').val();
        var calc_size    = $('#calc_size').val();
        var calc_descricao = $('#calc_descricao').val();
        var product_price = $('#product_price').val();

        if(calc_title == ""){
          $('#calc_title').focus();
          $('#calc_title').css({'border':'1px solid red'});
        }
        else if(calc_size == ""){
          $('#calc_size').focus();
          $('#calc_size').css({'border':'1px solid red'});
        }
        else if(calc_descricao == ""){
          $('#calc_descricao').focus();
          $('#calc_descricao').css({'border':'1px solid red'});
        }
