...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Adicionar Fogões');?></title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Fogões');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <input type="text" name="fog_id" id="fog_id" style="display: none;">
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    <label for="fog_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="fog_title" id="fog_title" placeholder="Titulo do Produto">
                  </div>
                  </td>
                  <td>
                    <div class="form-group">
                    <label for="fog_type"><?php echo get_phrase('Tipo');?></label>
                    <select class="form-control" name="fog_type" id="fog_type" style="display: block;height:38px;width:50%; padding:5px;">
                      <option value="A Gás"><?php echo get_phrase('A Gás');?></option>
                      <option value="Elétrico"><?php echo get_phrase('Elétrico');?></option>
                      <option value="A Gás & Elétrico"><?php echo get_phrase('A Gás & Elétrico');?></option>
                    </select>
                  </div>
                </td>
                </tr>
                <tr>
                  ...
                  <div class="form-group">
                    <label for="fog_number"><?php echo get_phrase('Número de Bocas');?></label>
                    <input type="text" class="form-control" name="fog_number" id="fog_number" placeholder="2,4,6 ou 8 Bocas">
                  </div>
                  </td>
                  <td style="border-top: none;">
                  <div class="form-group">
                    <label for="fog_cor"><?php echo get_phrase('Cor');?></label>
                    <select class="form-control" name="fog_cor" id="fog_cor" style="display: block;height:38px;width:50%; padding:5px;">
                ...
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="fog_descricao"><?php echo get_phrase('Descrição');?></label>
                    <textarea class="form-control" rows="3" name="fog_descricao" id="fog_descricao" placeholder="Informaçao Adicional"></textarea>
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="btnSave_fog" id="btnSave_fog" class="btn btn-primary"><?php echo get_phrase('Salvar & Continuar');?></button>
                  <button type="reset" class="btn btn-outline-danger" id="btnCancel_fog" name="btnCancel_fog"><?php echo get_phrase('Cancelar');?></button>
                </div>
            </div>
            <!-- /.card -->
...
<script type="text/javascript">
  ...
  GetBicName()
      ...
      $('#btnSave_fog').click(function(){
        var fog_title     = $('#fog_title').val();
        var fog_cor  = $('#fog_cor').val();
        var fog_number    = $('#fog_number').val();
        var fog_type       = $('#fog_type').val();
        var fog_descricao = $('#fog_descricao').val();
        var product_price = $('#product_price').val();

        if(fog_title == ""){
          $('#fog_title').focus();
          $('#fog_title').css({'border':'1px solid red'});
        }
        else if(fog_number == ""){
          $('#fog_number').focus();
          $('#fog_number').css({'border':'1px solid red'});
        }
        else if(fog_descricao == ""){
          $('#fog_descricao').focus();
          $('#fog_descricao').css({'border':'1px solid red'});
        }
