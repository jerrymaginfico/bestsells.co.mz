...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Adicionar Calçados Femeninos');?></title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Calçados Femeninos');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <input type="text" name="calc_id" id="calc_id" style="display: none;">
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    <label for="mfoot_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="mfoot_title" id="mfoot_title" placeholder="Nome do Produto">
                  </div>
                  </td>
                  <td>
                    <div class="form-group">
                    <label for="mfoot_size"><?php echo get_phrase('Tamanho');?></label>
                    <input type="text" class="form-control" name="mfoot_size" id="mfoot_size" placeholder="Tamanho dos Calçados">
                  </div>
                 </td>
                </tr>
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="mfoot_descricao"><?php echo get_phrase('Descrição');?></label>
                    <textarea class="form-control" rows="3" name="mfoot_descricao" id="mfoot_descricao" placeholder="Informaçao Adicional..."></textarea>
                  </div>
                  </td>
                   <td style="border-top: none;">
                   <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="btnSave_Wfoot" id="btnSave_Wfoot" class="btn btn-primary"><?php echo get_phrase('Salvar & Continuar');?></button>
  ...
  $(function(){
   ...
   /*$('.modal').modal({
    ...
    //Modal Show Script End
      ...
      $('#btnSave_Wfoot').click(function(){
        var mfoot_title     = $('#mfoot_title').val();
        var mfoot_size    = $('#mfoot_size').val();
        var mfoot_descricao = $('#mfoot_descricao').val();
        var product_price = $('#product_price').val();

        if(mfoot_title == ""){
          $('#mfoot_title').focus();
          $('#mfoot_title').css({'border':'1px solid red'});
        }
        else if(mfoot_size == ""){
          $('#mfoot_size').focus();
          $('#mfoot_size').css({'border':'1px solid red'});
        }
        else if(mfoot_descricao == ""){
          $('#mfoot_descricao').focus();
          $('#mfoot_descricao').css({'border':'1px solid red'});
        }
