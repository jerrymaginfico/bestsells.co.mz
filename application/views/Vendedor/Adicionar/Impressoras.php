...
<head>
  ...
  <title><?php echo get_phrase('Best$ells | Adicionar Impressoras & Fotocopiadoras');?></title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Impressoras & Fotocopiadoras');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <input type="text" name="print_id" id="print_id" style="display: none;">
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    <label for="print_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="print_title" id="print_title" placeholder="Titulo do Produto">
                  </div>
                  </td>
                  <td>
                      <div class="form-group">
                ...
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="print_descricao"><?php echo get_phrase('Descrição');?></label>
                    <textarea class="form-control" rows="3" name="print_descricao" id="print_descricao" placeholder="Informaçao Adicional..."></textarea>
                  </div>
                  </td>
                   <td style="border-top: none;">
                   <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="btnSavePrinter" id="btnSavePrinter" class="btn btn-primary"><?php echo get_phrase('Salvar & Continuar');?></button>
                  <button type="reset" class="btn btn-outline-danger" id="btnCancel_Printer" name="btnCancel_Printer"><?php echo get_phrase('Cancelar');?></button>
                </div>
            </div>
            <!-- /.card -->
   ...
   /*$('.modal').modal({
    ...
    GetPrinterName()
      ...
      $('#btnSavePrinter').click(function(){
        var print_title     = $('#print_title').val();
        var mobile_brand    = $('#mobile_brand').val();
        var print_descricao = $('#print_descricao').val();
        var product_price = $('#product_price').val();

        if(print_title == ""){
          $('#print_title').focus();
          $('#print_title').css({'border':'1px solid red'});
        }
        else if(mobile_brand == ""){
          $('#mobile_brand').focus();
          $('#mobile_brand').css({'border':'1px solid red'});
        }
        else if(print_descricao == ""){
          $('#print_descricao').focus();
          $('#print_descricao').css({'border':'1px solid red'});
        }
      ...
      $('#btnCancel_Printer').click(function(){
        $('#print_title').val("");
        $('#product_price').val("");
        $('#print_descricao').val("");
      });
