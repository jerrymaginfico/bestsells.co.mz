...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Adicionar Blusas, Camisas &/Ou Camisetes Femeninas');?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Blusas, Camisas & Camisetes Femeninas');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    <label for="wshirt_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="wshirt_title" id="wshirt_title" placeholder="Nome do Produto">
                  </div>
                  </td>
                  <td>
                    <div class="form-group">
                    <label for="wshirt_size"><?php echo get_phrase('Tamanho');?></label>
                    <input type="text" class="form-control" name="wshirt_size" id="wshirt_size" placeholder="Tamanho do Produto">
                  </div>
                 </td>
                </tr>
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="wshirt_descricao"><?php echo get_phrase('Descrição');?></label>
                    <textarea class="form-control" rows="3" name="wshirt_descricao" id="wshirt_descricao" placeholder="Informaçao Adicional..."></textarea>
                  </div>
                  </td>
                   <td style="border-top: none;">
                   <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="btnSave_Wshirt" id="btnSave_Wshirt" class="btn btn-primary"><?php echo get_phrase('Salvar & Continuar');?></button>
  ...
  $(function(){
   ...
   /*$('.modal').modal({
    ...
    //Modal Show Script End
      ...
      $('#btnSave_Wshirt').click(function(){
        var wshirt_title     = $('#wshirt_title').val();
        var wshirt_size    = $('#wshirt_size').val();
        var wshirt_descricao = $('#wshirt_descricao').val();
        var product_price = $('#product_price').val();

        if(wshirt_title == ""){
          $('#wshirt_title').focus();
          $('#wshirt_title').css({'border':'1px solid red'});
        }
        else if(wshirt_size == ""){
          $('#wshirt_size').focus();
          $('#wshirt_size').css({'border':'1px solid red'});
        }
        else if(wshirt_descricao == ""){
          $('#wshirt_descricao').focus();
          $('#wshirt_descricao').css({'border':'1px solid red'});
        }
