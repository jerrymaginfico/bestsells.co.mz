...
<head>
  ...
  <title><?php echo get_phrase('Best$ells | Adicionar Televisores');?></title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Televisores');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <input type="text" name="tv_id" id="tv_id" style="display: none;">
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    <label for="tv_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="tv_title" id="tv_title" placeholder="Titulo do Produto">
                  </div>
                  </td>
                  <td>
                     <div class="form-group">
                ...
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="tv_size"><?php echo get_phrase('Tamanho');?></label>
                    <input type="text" class="form-control" name="tv_size" id="tv_size" placeholder="Ex: 32 polegadas">
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="tv_cor"><?php echo get_phrase('Cor');?></label>
                    <select name="tv_cor" id="tv_cor" style="display: block;height:38px;width:50%; padding:5px;">
                ...
                <tr>
                 <td style="border-top: none;">
                    <div class="form-group">
                    <label for="tv_descricao"><?php echo get_phrase('Descrição');?></label>
                    <textarea class="form-control" rows="3" name="tv_descricao" id="tv_descricao" placeholder="Informaçao Adicional"></textarea>
                  </div>
                  </td>
                   <td style="border-top: none;">
                   <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="btnSave_Tv" id="btnSave_Tv" class="btn btn-primary"><?php echo get_phrase('Salvar & Continuar');?></button>
...
<script type="text/javascript">
  ...
  GetTv()
      ...
      $('#btnSave_Tv').click(function(){
        var tv_title     = $('#tv_title').val();
        var mobile_brand  = $('#mobile_brand').val();
        var tv_size    = $('#tv_size').val();
        var tv_cor       = $('#tv_cor').val();
        var tv_descricao      = $('#tv_descricao').val();
        var product_price = $('#product_price').val();

        if(tv_title == ""){
          $('#tv_title').focus();
          $('#tv_title').css({'border':'1px solid red'});
        }
        else if(tv_size == ""){
          $('#tv_size').focus();
          $('#tv_size').css({'border':'1px solid red'});
        }
        else if(tv_descricao == ""){
          $('#tv_descricao').focus();
          $('#tv_descricao').css({'border':'1px solid red'});
        }
