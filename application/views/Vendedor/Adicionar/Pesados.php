...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Adicionar Carros Pesados');?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Carros Pesados');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    <label for="pes_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="pes_title" id="pes_title" placeholder="Titulo do Produto">
                  </div>
                  </td>
                  <td>
                     <div class="form-group">
                ...
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="pes_modelo"><?php echo get_phrase('Modelo');?></label>
                    <input type="text" class="form-control" name="pes_modelo" id="pes_modelo" placeholder="Modelo do Carro. Ex: Modelo...">
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="pes_cor"><?php echo get_phrase('Cor');?></label>
                    <select name="pes_cor" id="pes_cor" style="display: block;height:38px;width:50%; padding:5px;">
                ...
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="pes_quilometragem"><?php echo get_phrase('Quilometragem');?></label>
                    <input type="text" class="form-control" name="pes_quilometragem" id="pes_quilometragem" placeholder="Ex: 10300 KM">
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="pes_combustivel"><?php echo get_phrase('Tipo de Combustivel');?></label>
                    <input type="text" class="form-control" name="pes_combustivel" id="pes_combustivel" placeholder="Ex: Gasolina, Diesel">
                  </div>
                  </td>
                </tr>
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="pes_ano"><?php echo get_phrase('Ano');?></label>
                    <input type="text" class="form-control" name="pes_ano" id="pes_ano" placeholder="Ex: 2010">
                    </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="pes_transmissao"><?php echo get_phrase('Transmissão');?></label>
                    <input type="text" class="form-control" name="pes_transmissao" id="pes_transmissao" placeholder="Ex: Automática, Manual">
                  </div>
                  </td>
                </tr>
                <tr>
                  <td style="border-top: none;">
                   <div class="form-group">
                    <label for="pes_descricao"><?php echo get_phrase('Descrição');?></label>
                    <textarea class="form-control" rows="3" name="pes_descricao" id="pes_descricao" placeholder="Estado, Peso Suportado..."></textarea>
                  </div>
                  </td>
                  <td style="border-top: none;">
                   <div class="form-group">
                ...
                <div class="card-footer">
                  ...
                  <button type="reset" class="btn btn-outline-danger" name="btnCancel" id="btnCancel"><?php echo get_phrase('Cancelar');?></button>
                </div>
            </div>
            <!-- /.card -->
...
<script type="text/javascript">
  ...
  GetCarName()
      ...
      $('#btn_SaveCar').click(function(){
        var pes_title     = $('#pes_title').val();
        var mobile_brand  = $('#mobile_brand').val();
        var pes_modelo    = $('#pes_modelo').val();
        var pes_cor       = $('#pes_cor').val();
        var pes_quilometragem = $('#pes_quilometragem').val();
        var pes_combustivel = $('#pes_combustivel').val();
        var pes_ano       = $('#pes_ano').val();
        var pes_transmissao     = $('#pes_transmissao').val();
        var pes_descricao      = $('#pes_descricao').val();
        var product_price = $('#product_price').val();

        if(pes_title == ""){
          $('#pes_title').focus();
          $('#pes_title').css({'border':'1px solid red'});
        }
        else if(pes_modelo == ""){
          $('#pes_modelo').focus();
          $('#pes_modelo').css({'border':'1px solid red'});
        }
        else if(pes_descricao == ""){
          $('#pes_descricao').focus();
          $('#pes_descricao').css({'border':'1px solid red'});
        }
