...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Adicionar Laptops');?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Laptops');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="lap_title" id="lap_title" placeholder="Titulo do Produto">
                  </div>
                  </td>
                  <td>
                     <div class="form-group">
                ...
                <tr>
                  <td style="border-top: none;">
                    ...
                    <input type="text" class="form-control" name="lap_so" id="lap_so" placeholder="Windows, MacOS, Ubuntu, ...">
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="lap_ram"><?php echo get_phrase('Memória RAM');?></label>
                    <select class="form-control" name="lap_ram" id="lap_ram" style="height:38px;width:50%; padding:5px;">
                ...
                <tr>
                  <td style="border-top: none;">
                    ...
                    <input type="text" class="form-control" name="lap_processor" id="lap_processor" placeholder="Ex: Dual Core, Quad Core, Core 2 Du0, Core i3, Core i5, Core i7, ...">
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="lap_size"><?php echo get_phrase('Tamanho');?></label>
                     <input type="text" class="form-control" name="lap_size" id="lap_size" placeholder="Ex: 16 polegadas, ...">
                  </div>
                  </td>
                </tr>
                <tr>
                  <td style="border-top: none;">
                    ...
                    <select class="form-control" name="lap_hdd" id="lap_hdd">
                  ...
                  <td style="border-top: none;">
                    ...
                    <textarea class="form-control" rows="3" name="lap_descricao" id="lap_descricao" placeholder="Informação adicional..."></textarea>
                  </div>
                  </td>
                </tr>
                <tr>
                ...
                <div class="card-footer">
                  <button type="submit" name="btnSave_Lap" id="btnSave_Lap" class="btn btn-primary"><?php echo get_phrase('Salvar & Continuar');?></button>
                  <button type="reset" class="btn btn-outline-danger" id="btnCancel_Lap" name="btnCancel_Lap"><?php echo get_phrase('Cancelar');?></button>
                </div>
            </div>
            <!-- /.card -->
...
<script type="text/javascript">
  ...
  GetComputerName()
      ...
      $('#btnSave_Lap').click(function(){
        var lap_title     = $('#lap_title').val();
        var mobile_brand  = $('#mobile_brand').val();
        var lap_size    = $('#lap_size').val();
        var lap_so       = $('#lap_so').val();
        var lap_processor     = $('#lap_processor').val();
        var lap_hdd = $('#lap_hdd').val();
        var lap_ram       = $('#lap_ram').val();
        var lap_descricao = $('#lap_descricao').val();
        var product_price = $('#product_price').val();

        if(lap_title == ""){
          $('#lap_title').focus();
          $('#lap_title').css({'border':'1px solid red'});
        }
        else if(lap_size == ""){
          $('#lap_size').focus();
          $('#lap_size').css({'border':'1px solid red'});
        }
        else if(lap_descricao == ""){
          $('#lap_descricao').focus();
          $('#lap_descricao').css({'border':'1px solid red'});
        }
