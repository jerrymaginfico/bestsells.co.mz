...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Adicionar Geleiras &/Ou Congeladores');?></title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Geleiras & Congeladores');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <input type="text" name="free_id" id="free_id" style="display: none;">
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    <label for="freeze_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="freeze_title" id="freeze_title" placeholder="Titulo do Produto">
                  </div>
                  </td>
                  <td>
                     <div class="form-group">
                ...
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="freeze_type"><?php echo get_phrase('Tipo');?></label>
                    <input type="text" class="form-control" name="freeze_type" id="freeze_type" placeholder="Geleira, Congelador, Frigo-Bar...">
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="freeze_size"><?php echo get_phrase('Tamanho');?></label>
                    <input type="text" class="form-control" name="freeze_size" id="freeze_size" placeholder="Altura,Largura">
                  </div>
                  </td>
                </tr>
                <tr>
                  <td style="border-top: none;">
                  <div class="form-group">
                    <label for="freeze_cor"><?php echo get_phrase('Cor');?></label>
                    <select class="form-control" name="freeze_cor" id="freeze_cor" style="display: block;height:38px;width:50%; padding:5px;">
                  ...
                  <td style="border-top: none;">
                  <div class="form-group">
                    <label for="freeze_descricao"><?php echo get_phrase('Descrição');?></label>
                    <textarea class="form-control" rows="3" name="freeze_descricao" id="freeze_descricao" placeholder="Informaçao Adicional"></textarea>
                  </div>
                  </td>
                </tr>
                <tr>
                ...
                <div class="card-footer">
                  <button type="submit" name="btnSave_freeze" id="btnSave_freeze" class="btn btn-primary"><?php echo get_phrase('Salvar & Continuar');?></button>
                  <button type="reset" class="btn btn-outline-danger" id="btnCancel_freeze" name="btnCancel_freeze"><?php echo get_phrase('Cancelar');?></button>
                </div>
            </div>
            <!-- /.card -->
...
<script type="text/javascript">
  ...
  GetBicName()
      ...
      /* Limpar Campos */
      $('#btnCancel_freeze').click(function(){
       $('#freeze_title').val("");
       $('#freeze_type').val("");
       $('#freeze_size').val("");
       $('#freeze_descricao').val("");
       $('#product_price').val("");
      });

      /* Insert Car Section Start */

      $('#btnSave_freeze').click(function(){
        var freeze_title     = $('#freeze_title').val();
        var mobile_brand  = $('#mobile_brand').val();
        var freeze_type    = $('#freeze_type').val();
        var freeze_size   = $('#freeze_size').val();
        var freeze_cor       = $('#freeze_cor').val();
        var freeze_descricao = $('#freeze_descricao').val();
        var product_price = $('#product_price').val();

        if(freeze_title == ""){
          $('#freeze_title').focus();
          $('#freeze_title').css({'border':'1px solid red'});
        }
        else if(freeze_type == ""){
          $('#freeze_type').focus();
          $('#freeze_type').css({'border':'1px solid red'});
        }
        else if(freeze_descricao == ""){
          $('#freeze_descricao').focus();
          $('#freeze_descricao').css({'border':'1px solid red'});
        }
