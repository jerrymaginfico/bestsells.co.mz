...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Adicionar Bicicletas');?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Bicicletas');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    <label for="bic_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="bic_title" id="bic_title" placeholder="Titulo do Produto">
                  </div>
                  </td>
                  <td>
                     <div class="form-group">
                ...
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="bic_modelo"><?php echo get_phrase('Modelo');?></label>
                    <input type="text" class="form-control" name="bic_modelo" id="bic_modelo" placeholder="Modelo do Carro. Ex: Xtreme...">
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="bic_cor"><?php echo get_phrase('Cor');?></label>
                    <select name="bic_cor" id="bic_cor" style="display: block;height:38px;width:50%; padding:5px;">
                ...
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="bic_descricao"><?php echo get_phrase('Descrição');?></label>
                    <textarea class="form-control" rows="3" name="bic_descricao" id="bic_descricao" placeholder="Informaçao Adicional"></textarea>
                  </div>
                  </td>
                   <td style="border-top: none;">
                   <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="btnSaveBic" id="btnSaveBic" class="btn btn-primary"><?php echo get_phrase('Salvar & Continuar');?></button>
...
<script type="text/javascript">
  ...
  GetBicName()
      ...
      $('#btnSaveBic').click(function(){
        var bic_title     = $('#bic_title').val();
        var mobile_brand  = $('#mobile_brand').val();
        var bic_modelo    = $('#bic_modelo').val();
        var bic_cor       = $('#bic_cor').val();
        var bic_descricao = $('#bic_descricao').val();
        var product_price = $('#product_price').val();

        if(bic_title == ""){
          $('#bic_title').focus();
          $('#bic_title').css({'border':'1px solid red'});
        }
        else if(bic_modelo == ""){
          $('#bic_modelo').focus();
          $('#bic_modelo').css({'border':'1px solid red'});
        }
        else if(bic_descricao == ""){
          $('#bic_descricao').focus();
          $('#bic_descricao').css({'border':'1px solid red'});
        }
