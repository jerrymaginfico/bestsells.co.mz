...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Adicionar Camisas & Camisetes');?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Camisas & Camisetes');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    <label for="shirt_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="shirt_title" id="shirt_title" placeholder="Nome do Produto">
                  </div>
                  </td>
                  <td>
                    <div class="form-group">
                    <label for="shirt_size"><?php echo get_phrase('Tamanho');?></label>
                    <input type="text" class="form-control" name="shirt_size" id="shirt_size" placeholder="Tamanho do Produto">
                  </div>
                 </td>
                </tr>
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="shirt_descricao"><?php echo get_phrase('Descrição');?></label>
                    <textarea class="form-control" rows="3" name="shirt_descricao" id="shirt_descricao" placeholder="Informaçao Adicional..."></textarea>
                  </div>
                  </td>
                   <td style="border-top: none;">
                   <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="btnSaveInfo" id="btnSaveInfo" class="btn btn-primary"><?php echo get_phrase('Salvar & Continuar');?></button>
   ...
   /*$('.modal').modal({
    ...
    //Modal Show Script End
      ...
      $('#btnSaveInfo').click(function(){
        var shirt_title     = $('#shirt_title').val();
        var shirt_size    = $('#shirt_size').val();
        var shirt_descricao = $('#shirt_descricao').val();
        var product_price = $('#product_price').val();

        if(shirt_title == ""){
          $('#shirt_title').focus();
          $('#shirt_title').css({'border':'1px solid red'});
        }
        else if(shirt_size == ""){
          $('#shirt_size').focus();
          $('#shirt_size').css({'border':'1px solid red'});
        }
        else if(shirt_descricao == ""){
          $('#shirt_descricao').focus();
          $('#shirt_descricao').css({'border':'1px solid red'});
        }
