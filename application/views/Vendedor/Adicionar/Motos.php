...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Adicionar Motos & Triciclos');?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo get_phrase('Motos & Triciclos');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <table class="table">
                <tr>
                  ...
                  <div class="form-group">
                    <label for="moto_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="moto_title" id="moto_title" placeholder="Titulo do Produto">
                  </div>
                  </td>
                  <td>
                     <div class="form-group">
                ...
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="moto_modelo"><?php echo get_phrase('Modelo');?></label>
                    <input type="text" class="form-control" name="moto_modelo" id="moto_modelo" placeholder="Modelo do Carro. Ex: Xtreme...">
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="moto_cor"><?php echo get_phrase('Cor');?></label>
                    <select name="moto_cor" id="moto_cor" style="display: block;height:38px;width:50%; padding:5px;">
                ...
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="moto_quilometragem"><?php echo get_phrase('Quilometragem');?></label>
                    <input type="text" class="form-control" name="moto_quilometragem" id="moto_quilometragem" placeholder="Ex: 10300 KM">
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="moto_combustivel"><?php echo get_phrase('Tipo de Combustivel');?></label>
                    <input type="text" class="form-control" name="moto_combustivel" id="moto_combustivel" placeholder="Ex: Gasolina, Diesel">
                  </div>
                  </td>
                </tr>
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="moto_ano"><?php echo get_phrase('Ano');?></label>
                    <input type="text" class="form-control" name="moto_ano" id="moto_ano" placeholder="Ex: 2010">
                    </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="moto_descricao"><?php echo get_phrase('Descrição');?></label>
                    <textarea class="form-control" rows="3" name="moto_descricao" id="moto_descricao" placeholder="Informaçao Adicional"></textarea>
                  </div>
                  </td>
                </tr>
                <tr>
                ...
                <div class="card-footer">
                  <button type="submit" name="btnSave_Moto" id="btnSave_Moto" class="btn btn-primary"><?php echo get_phrase('Salvar & Continuar');?></button>
...
<script type="text/javascript">
  ...
  GetMotoName()
      ...
      $('#btnSave_Moto').click(function(){
        var moto_title     = $('#moto_title').val();
        var mobile_brand  = $('#mobile_brand').val();
        var moto_modelo    = $('#moto_modelo').val();
        var moto_cor       = $('#moto_cor').val();
        var moto_quilometragem = $('#moto_quilometragem').val();
        var moto_combustivel = $('#moto_combustivel').val();
        var moto_ano       = $('#moto_ano').val();
        var moto_descricao      = $('#moto_descricao').val();
        var product_price = $('#product_price').val();

        if(moto_title == ""){
          $('#moto_title').focus();
          $('#moto_title').css({'border':'1px solid red'});
        }
        else if(moto_modelo == ""){
          $('#moto_modelo').focus();
          $('#moto_modelo').css({'border':'1px solid red'});
        }
        else if(moto_descricao == ""){
          $('#moto_descricao').focus();
          $('#moto_descricao').css({'border':'1px solid red'});
        }
          ...
          $.ajax({
            ...
            success:function(data){
              ...
              $('#moto_title').val("");
              $('#moto_modelo').val("");
              $('#moto_quilometragem').val("");
              $('#moto_combustivel').val("");
              $('#moto_ano').val("");
              $('#product_price').val("");
              $('#moto_descricao').val("");
