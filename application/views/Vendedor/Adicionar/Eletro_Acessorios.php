...
<head>
  ...
  <title><?php echo get_phrase('Best$ells | Adicionar Acessórios Eletrodomesticos');?></title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url()?>Vendedor/Dashboard">Home</a></li>
              <li class="breadcrumb-item active"><?php echo get_phrase('Acessorios Eletrodomesticos');?></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <input type="text" name="acc_id" id="acc_id" style="display: none;">
            ...
            <div class="card card-primary">
              ...
              <table class="table">
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                    <label for="ac_brand"><?php echo get_phrase('Marca');?></label>
                    <input type="text" class="form-control" name="ac_brand" id="ac_brand" placeholder="Marca do produto...">
                  </div>
                 </td>
                </tr>
                <tr>
                  <td style="border-top: none;">
                    ...
                    <textarea class="form-control" rows="3" name="ac_descricao" id="ac_descricao" placeholder="Informaçao Adicional, Compatibilidade, ..."></textarea>
                  </div>
                  </td>
                   <td style="border-top: none;">
                   <div class="form-group">
                ...
                <div class="card-footer">
                  ...
                  <button type="reset" class="btn btn-outline-danger" id="btnCancel_Acc" name="btnCancel_Acc"><?php echo get_phrase('Cancelar');?></button>
                </div>
            </div>
            <!-- /.card -->
    ...
    //Modal Show Script End
      ...
      $('#btnSaveAcc').click(function(){
        ...
        if(ac_title == ""){
          ...
          $('#ac_brand').focus();
          $('#ac_brand').css({'border':'1px solid red'});
        }
