    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-header-pills card-primary">
          ...
          <!-- /.card-header -->
          <?=form_open('Vendedor/Update_Freeze/'.$freeze->freeze_id);?>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label><?php echo get_phrase('Titulo do Produto');?></label>
                  <input type="text" name="update_freezetitle" id="update_freezetitle" value="<?=$freeze->freeze_title;?>"class="form-control" required>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label><?php echo get_phrase('Tipo');?></label>
                  <input type="text" name="update_freezetype" id="update_freezetype" value="<?=$freeze->freeze_type;?>" class="form-control" required>
                </div>
                <!-- /.form-group -->

                <div class="form-group">
                  <label><?php echo get_phrase('Cor');?></label>
                  <input type="text" name="update_freezecor" id="update_freezecor" value="<?=$freeze->freeze_cor;?>" class="form-control" required>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Preco');?></label>
                  <input type="text" name="update_productprice" id="update_productprice" value="<?=number_format($freeze->product_price);?>" class="form-control" required>
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="update_brand" id="update_brand" style="width: 100%;">
                    <?php if(count($brand)): ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="update_freezesize" id="update_freezesize" value="<?=$freeze->freeze_size;?>" class="form-control" required>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Descricao');?></label>
                  <textarea rows="3" class="form-control" name="update_freezedescricao" id="update_freezedescricao" required><?=$freeze->freeze_descricao;?></textarea>  
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-primary" id="update_freeze" name="update_freeze"><?php echo get_phrase('Gravar Dados');?></button>
            <a href="<?php echo base_url('Vendedor/Update_freeze_images/'.$freeze->freeze_id);?>" class="btn btn-dark"><?php echo get_phrase('Actualizar Imagens');?></a>
          </div>
          <?=form_close();?>
