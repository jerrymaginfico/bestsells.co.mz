      ...
      <div class="container-fluid">
        ...
        <!-- general form elements -->
            <div class="card card-danger">
              ...
              <h3 class="card-title"><?php echo get_phrase('Eliminar Produto Com ID:');?> <?=$lap->lap_id;?></h3> 
               <?=form_open('Vendedor/remove_laptop/'.$lap->lap_id);?>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <table class="table">
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-danger" id="remove_laptop" name="remove_laptop"><?php echo get_phrase('Eliminar Produto');?></button>
          </div>
          <?=form_close();?>
