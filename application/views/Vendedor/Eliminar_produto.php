        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Dashboard / Eliminar</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-danger">
          <div class="card-header">
            <h3 class="card-title"><?php echo get_phrase('Eliminar Produto Com ID:');?> <?=$cars->part_id;?></h3>

          </div>
          <!-- /.card-header -->
          <?=form_open('Vendedor/remove_product/'.$cars->part_id);?>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label><?php echo get_phrase('Titulo do Produto');?></label>
                  <input type="text" name="update_title" id="update_title" value="<?=$cars->part_title;?>"class="form-control" readonly>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label><?php echo get_phrase('Modelo do Carro');?></label>
                  <input type="text" name="update_modelo" id="update_modelo" value="<?=$cars->part_modelo;?>" class="form-control" readonly>
                </div>
                <!-- /.form-group -->

                <div class="form-group">
                  <label><?php echo get_phrase('Quilometragem');?></label>
                  <input type="text" name="update_quilometragem" id="update_quilometragem" value="<?=$cars->part_quilometragem;?>" class="form-control" readonly>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Ano');?></label>
                  <input type="text" name="update_ano" id="update_ano" value="<?=$cars->part_ano;?>" class="form-control" readonly>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Tipo de Carro');?></label>
                  <input type="text" name="update_tipo" id="update_tipo" value="<?=$cars->part_tipocarro;?>" class="form-control" readonly>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Preco');?></label>
                  <input type="text" name="update_preco" id="update_preco" value="<?=number_format($cars->product_price);?>" class="form-control" readonly>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="update_cor" id="update_cor" value="<?=$cars->part_cor;?>" class="form-control" readonly>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Tipo de Combustivel');?></label>
                  <input type="text" name="update_combustivel" id="update_combustivel" value="<?=$cars->part_combustivel;?>" class="form-control" readonly>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Transmissao');?></label>
                  <input type="text" name="update_transmissao" id="update_transmissao" value="<?=$cars->part_transmissao;?>" class="form-control" readonly>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Descricao');?></label>
                  <textarea rows="3" class="form-control" name="update_descricao" id="update_descricao" readonly><?=$cars->part_descricao;?></textarea>  
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-outline-danger" id="delete_car" name="delete_car"><?php echo get_phrase('Eliminar');?></button>
          </div>
          <?=form_close();?>
