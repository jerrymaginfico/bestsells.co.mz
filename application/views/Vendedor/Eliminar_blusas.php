  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- SELECT2 EXAMPLE -->
        <div class="card card-header-pills card-danger">
          <div class="card-header">
            <h3 class="card-title"><?php echo get_phrase('Eliminar do Produto Com ID:');?><?=$blusa->wshirt_id;?></h3>
          </div>
          <?=form_open('Vendedor/delete_wshirt/'.$blusa->wshirt_id);?>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-outline-danger" id="delete_wshirt" name="delete_wshirt"><?php echo get_phrase('Eliminar Produto');?></button>
          </div>
          <?=form_close();?>
