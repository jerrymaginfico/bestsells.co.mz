    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-header-pills card-primary">
          ...
          <!-- /.card-header -->
          <?=form_open('Vendedor/Update_Shirt/'.$shirt->shirt_id);?>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label><?php echo get_phrase('Titulo do Produto');?></label>
                  <input type="text" name="shirt_title" id="shirt_title" value="<?=$shirt->shirt_title;?>"class="form-control" required>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label><?php echo get_phrase('Descricao');?></label>
                  <textarea rows="3" class="form-control" name="shirt_descricao" id="shirt_descricao" required><?=$shirt->shirt_descricao;?></textarea>  
                </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="shirt_size" id="shirt_size" value="<?=$shirt->shirt_size;?>" class="form-control" required>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Preco');?></label>
                  <input type="text" name="product_price" id="product_price" value="<?=number_format($shirt->product_price);?>" class="form-control" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-primary" id="update_shirt" name="update_shirt"><?php echo get_phrase('Gravar Dados');?></button>
            <a href="<?php echo base_url('Vendedor/Update_Shirt_images/'.$shirt->shirt_id);?>" class="btn btn-dark"><?php echo get_phrase('Actualizar Imagens');?></a>
          </div>
          <?=form_close();?>
