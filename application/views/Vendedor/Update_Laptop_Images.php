	...
	<body>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#"><?=$lap->categoria;?></a></li>
						<li><a href="#">Actualizar Imagens</a></li>
						<li><a href="#"><?=$lap->lap_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
		...
		<div class="section">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							<div class="product-preview">
								<?php if($lap->image_one == ""):?>
				                  <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
				                  <?php else: ?>
				                	<img src="<?= base_url().'EletronicImages/'.$lap->image_one;?>" class="product-image" alt="Product Image">
				                <?php endif;?>
							</div>

							<div class="product-preview">
							<?php if($lap->image_two == ""):?>
				                 <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
				                  <?php else: ?>
				                <img src="<?= base_url().'EletronicImages/'.$lap->image_two;?>" class="product-image" alt="Product Image">
				                <?php endif;?>
							</div>

							<div class="product-preview">
							<?php if($lap->image_three == ""):?>
                  				<img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
                  				<?php else: ?>
                				<img src="<?= base_url().'EletronicImages/'.$lap->image_three;?>" class="product-image" alt="Product Image">
                			<?php endif;?>
							</div>

							<div class="product-preview">
								<?php if($lap->image_four == ""):?>
				                  <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
				                  <?php else: ?>
				                <img src="<?= base_url().'EletronicImages/'.$lap->image_four;?>" class="product-image" alt="Product Image">
				                <?php endif;?>
							</div>
						</div>
					</div>
			...
			<div class="card-footer">
	            <?=form_open_multipart('Vendedor/laptop_image_update/'.$lap->lap_id);?>
