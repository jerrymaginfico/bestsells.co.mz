...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Lista de Camisetes & Camisas Masculinas');?></title>
  <link rel="shortcut icon" href="<?php echo base_url();?>bestsells/img/bestlogo.png">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Lista de Camisetes & Camisas Masculinas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
             ...
             <div class="card-header">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        <select class="custom-select" id="listing_type" name="listing_type" style="width: 100%;" required>
                          ...
                          <option value="camisas masculinas" selected><?php echo get_phrase('Camisas Masculinas');?></option>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php if(count($shirt)):?>
                      <?php foreach($shirt as $shirt):?>
                  <tr>
                    <td><?=$shirt->shirt_title;?></td>
                    <td><?=$shirt->product_status;?></td>
                    <td><?=number_format($shirt->product_price);?></td>
                    <td><?=$shirt->data_cadastro;?></td>
                    <td>
                      <center>
                      <a href="<?=base_url('Vendedor/Editar_Info/'.$shirt->shirt_id);?>" title="Editar Dados" class="btn btn-info btn-circle btn-sm"><i class="fa fa-edit"></i></a>
                      <a href="<?=base_url('Vendedor/Editar_Estado/'.$shirt->shirt_id);?>" class="btn btn-warning btn-circle btn-sm" title="Editar Estado"><i class="fa fa-ban"></i></a>
                      <a href="<?=base_url('Vendedor/Eliminar_Camisete/'.$shirt->shirt_id);?>" title="Remover Produto" class="btn btn-danger btn-circle btn-sm text-white"><i class="fa fa-times"></i></a>
                      </center>
                    </td>
                  </tr>
                <?php endforeach;
