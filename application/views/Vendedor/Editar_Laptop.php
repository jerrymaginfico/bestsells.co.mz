        ...
        <!-- general form elements -->
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><?php echo get_phrase('Actualizar Dados do Laptop');?></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
               <?=form_open('Vendedor/Update_Laptop/'.$lap->lap_id);?>
              <table class="table">
                <tr>
                  <td>
                  <div class="form-group">
                    <label for="lap_title"><?php echo get_phrase('Titulo do Produto');?></label>
                    <input type="text" class="form-control" name="lap_title" id="lap_title" value="<?=$lap->lap_title;?>">
                  </div>
                  </td>
                  <td>
                    <div class="form-group">
                ...
                <tr>
                  <td style="border-top: none;">
                    ...
                    <input type="text" class="form-control" name="lap_so" id="lap_so" value="<?=$lap->lap_so;?>">
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                ...
                <tr>
                  <td style="border-top: none;">
                    ...
                    <input type="text" class="form-control" name="lap_processor" id="lap_processor" value="<?=$lap->lap_processor?>">
                  </div>
                  </td>
                  <td style="border-top: none;">
                    <div class="form-group">
                    <label for="lap_size"><?php echo get_phrase('Tamanho');?></label>
                     <input type="text" class="form-control" name="lap_size" id="lap_size" value="<?=$lap->lap_size;?>">
                  </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="border-top: none;">
                    ...
                    <textarea class="form-control" rows="3" name="lap_descricao" id="lap_descricao"><?=$lap->lap_descricao;?></textarea>
                  </div>
                  </td>
               </tr>   
                <tr>
                  <td style="border-top: none;">
                    <div class="form-group">
                      ...
                      <input type="text" name="product_price" id="product_price" class="form-control" value="<?=$lap->product_price;?>">
                    </div>
                  </td>
                </tr>
              </table>
          ...
          <div class="card-footer">
            ...
            <a href="<?php echo base_url('Vendedor/Update_Laptop_images/'.$lap->lap_id);?>" class="btn btn-dark"><?php echo get_phrase('Actualizar Imagens');?></a>
          </div>
          <?=form_close();?>
