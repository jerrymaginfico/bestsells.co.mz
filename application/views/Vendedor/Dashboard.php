...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Dashboard do Vendedor');?></title>
            ...
            <div class="card">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        <select class="custom-select" id="listing_type" name="listing_type" style="width: 100%;" required>
                          <option value="" selected disabled><?php echo get_phrase('Deseja Listar?');?></option>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    <td colspan="5
                    "><?php echo get_phrase('Sem Conteudo! Escolha Um Item Acima e Saiba Mais');?></td>
                  </tr>
                  </tbody>
                  <tfoot>
                  <tr>
