    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-header-pills card-primary">
          ...
          <!-- /.card-header -->
          <?=form_open('Vendedor/Update_Wshirt/'.$blusa->wshirt_id);?>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label><?php echo get_phrase('Titulo do Produto');?></label>
                  <input type="text" name="wshirt_title" id="wshirt_title" value="<?=$blusa->wshirt_title;?>"class="form-control" required>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label><?php echo get_phrase('Descricao');?></label>
                  <textarea rows="3" class="form-control" name="wshirt_descricao" id="wshirt_descricao" required><?=$blusa->wshirt_descricao;?></textarea>  
                </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="wshirt_size" id="wshirt_size" value="<?=$blusa->wshirt_size;?>" class="form-control" required>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Preco');?></label>
                  <input type="text" name="product_price" id="product_price" value="<?=number_format($blusa->product_price);?>" class="form-control" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-primary" id="update_wshirt" name="update_wshirt"><?php echo get_phrase('Gravar Dados');?></button>
            <a href="<?php echo base_url('Vendedor/Update_Wshirt_images/'.$blusa->wshirt_id);?>" class="btn btn-dark"><?php echo get_phrase('Actualizar Imagens');?></a>
          </div>
          <?=form_close();?>
