      ...
      <div class="container-fluid">
        ...
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title"><?php echo get_phrase('Actualizar Estado do Produto Com ID:');?> <?=$cars->part_id;?></h3>
            <br>
            <br>
            <?=form_open('Vendedor/set_status/'.$cars->part_id);?>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <textarea rows="2" class="form-control" name="update_descricao" id="update_descricao" readonly><?=$cars->part_descricao;?></textarea>  
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-info" id="status_car" name="status_car"><?php echo get_phrase('Actualizar Estado');?></button>
          </div>
          <?=form_close();?>
