...
<head>
  ...
  <title><?php echo get_phrase('BestSells | Lista de Geleiras & Congeladores');?></title>
  <link rel="shortcut icon" href="<?php echo base_url();?>bestsells/img/bestlogo.png">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Lista de Congeladores & Geleiras</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        <select class="custom-select" id="listing_type" name="listing_type" style="width: 100%;" required>
                          ...
                          <option value="geleiras & congeladores" selected><?php echo get_phrase('Geleiras & Congeladores');?></option>
                          <option value="celulares"><?php echo get_phrase('Celulares');?></option>
                          <option value="laptops"><?php echo get_phrase('Laptops');?></option>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php if(count($freeze)):?>
                      <?php foreach($freeze as $freezer):?>
                  <tr>
                    <td><?=$freezer->freeze_title;?></td>
                    <td><?=$freezer->product_status;?></td>
                    <td><?=number_format($freezer->product_price);?></td>
                    <td><?=$freezer->data_cadastro;?></td>
                    <td>
                      <center>
                      <a href="<?=base_url('Vendedor/Editar_Freeze/'.$freezer->freeze_id);?>" title="Editar Dados" class="btn btn-info btn-circle btn-sm"><i class="fa fa-edit"></i></a>
                      <a href="<?=base_url('Vendedor/Change_Freeze_Status/'.$freezer->freeze_id);?>" class="btn btn-warning btn-circle btn-sm" title="Editar Estado"><i class="fa fa-ban"></i></a>
                      <a href="<?=base_url('Vendedor/Eliminar_Freeze/'.$freezer->freeze_id);?>" title="Remover Produto" class="btn btn-danger btn-circle btn-sm text-white"><i class="fa fa-times"></i></a>
                      </center>
                    </td>
                  </tr>
                <?php endforeach;
