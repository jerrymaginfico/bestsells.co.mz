  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <li><a href="#"><?=$blusa->categoria;?></a></li>
            <li><a href="#">Atualizar Imagens</a></li>
            <li><a href="#"><?=$blusa->wshirt_title;?></a></li>
            </ul>
          </div>
        </div>
        <!-- /row -->
    ...
    <div class="section">
          ...
          <div class="col-md-5 col-md-push-2">
            <div id="product-main-img">
              <div class="product-preview">
                <?php if($blusa->image_one == ""):?>
                          <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
                          <?php else: ?>
                          <img src="<?= base_url().'WomenImages/'.$blusa->image_one;?>" class="product-image" alt="Product Image">
                        <?php endif;?>
              </div>

              <div class="product-preview">
              <?php if($blusa->image_two == ""):?>
                         <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
                          <?php else: ?>
                        <img src="<?= base_url().'WomenImages/'.$blusa->image_two;?>" class="product-image" alt="Product Image">
                        <?php endif;?>
              </div>
      ...
      <div class="card-footer">
              <?=form_open_multipart('Vendedor/wshirt_image_update/'.$blusa->wshirt_id);?>
              <h6><?php echo get_phrase('Actualizar Imagens (2)');?></h6>
              <br>
              <h6 style="font-size: 14px;font-weight: 500;"><?php echo get_phrase('Imagens do Produto');?></h6>
              <input type="file" name="image" id="image" style="border: 1px solid silver; padding: 10px; box-shadow: none;">
              <br>
              <br>
              <h6 style="font-size: 14px;font-weight: 500;"><?php echo get_phrase('Posicao da Imagem(1-2)');?></h6>
              <input type="text" class="form-control" name="image_position" id="image_position" placeholder="Ex.:1,2" style="width: 30%;" required>
              <br>
