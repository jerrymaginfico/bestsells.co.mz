  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <li><a href="#"><?=$shirt->categoria;?></a></li>
            <li><a href="#">Atualizar Imagens</a></li>
            <li><a href="#"><?=$shirt->shirt_title;?></a></li>
            </ul>
          </div>
        </div>
        <!-- /row -->
    ...
    <div class="section">
          ...
          <div class="col-md-5 col-md-push-2">
            <div id="product-main-img">
              <div class="product-preview">
                <?php if($shirt->image_one == ""):?>
                          <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
                          <?php else: ?>
                          <img src="<?= base_url().'MenImages/'.$shirt->image_one;?>" class="product-image" alt="Product Image">
                        <?php endif;?>
              </div>

              <div class="product-preview">
              <?php if($shirt->image_two == ""):?>
                         <img src="<?php echo base_url();?>bestsells/img/bestlogo.png" alt="Product Image">
                          <?php else: ?>
                        <img src="<?= base_url().'MenImages/'.$shirt->image_two;?>" class="product-image" alt="Product Image">
                        <?php endif;?>
              </div>
      ...
      <div class="card-footer">
              <?=form_open_multipart('Vendedor/shirt_image_update/'.$shirt->shirt_id);?>
