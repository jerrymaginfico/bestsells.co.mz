  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- SELECT2 EXAMPLE -->
        <div class="card card-header-pills card-info">
          <div class="card-header">
            <h3 class="card-title"><?php echo get_phrase('Actualizar Estado do Produto Com ID:');?><?=$blusa->wshirt_id;?></h3>
            <br>
            <br>
               <?=form_open('Vendedor/set_wshirt_status/'.$blusa->wshirt_id);?>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="wshirt_title" id="wshirt_title" value="<?=$blusa->wshirt_title;?>"class="form-control" required readonly>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label><?php echo get_phrase('Descricao');?></label>
                  <textarea rows="3" class="form-control" name="wshirt_descricao" id="wshirt_descricao" required readonly><?=$blusa->wshirt_descricao;?></textarea>  
                </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="wshirt_size" id="wshirt_size" value="<?=$blusa->wshirt_size;?>" class="form-control" required readonly>
                </div>

                <div class="form-group">
                  <label><?php echo get_phrase('Preco');?></label>
                  <input type="text" name="product_price" id="product_price" value="<?=number_format($blusa->product_price);?>" class="form-control" required readonly>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-info" id="update_wshirt_status" name="update_wshirt_status"><?php echo get_phrase('Actualizar');?></button>
          </div>
          <?=form_close();?>
