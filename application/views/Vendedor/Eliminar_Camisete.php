      ...
      <div class="container-fluid">
        ...
        <div class="card card-danger">
          <div class="card-header">
            <h3 class="card-title"><?php echo get_phrase('Eliminar Produto Com ID:');?><?=$shirt->shirt_id;?></h3>
          </div>
          <!-- /.card-header -->
          <?=form_open('Vendedor/remove_shirt/'.$shirt->shirt_id);?>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-outline-danger" id="delete" name="delete"><?php echo get_phrase('Eliminar Produto');?></button>
          </div>
          <?=form_close();?>
