...
<html lang="en">
	<head>
		...
		<title>BestSellS | Todas Camisas & Camisetes Masculinas</title>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<li><a href="<?php echo base_url('Home/index');?>">Home</a></li>
						...
						<li class="active"><a href="#">Moda Masculina</a>
							<ul>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Camisas Masculinas <?=count($results);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							<!-- product -->
							<?php if($results):?>
									<?php foreach($results as $man): ?>
							<div class="col-md-3 col-xs-6">
								
								<div class="product">
									<a href="<?php echo base_url('Home/camisa_masculina_info/'.$man->shirt_id);?>">
									<div class="product-img">
										<?php if($man->image_one == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive" style="height: 170px;">
										<?php else: ?>
										<img src="<?=base_url().'MenImages/'.$man->image_one;?>" class="responsive-img" style="height: 170px;">
										<?php endif;?>
									</div>
									<div class="product-body">
										<p class="product-category"><?=$man->categoria?></p>
										<h3 class="product-name"><a href="<?php echo base_url('Home/camisa_masculina_info/'.$man->shirt_id);?>"><?=word_limiter($man->shirt_title,3);?></a></h3>
										<h4 class="product-price"><?=number_format($man->product_price);?></h4>
									</div>
								</a>
								</div>
