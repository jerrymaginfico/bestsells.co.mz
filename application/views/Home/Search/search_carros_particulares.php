				...
				<h6 style="font-size:16px;;color:#fff;">Procurar</h6>
				 ...
				 <li>
						<select name="listing_items" id="listing_items">
								...
								<option value="carros particulares" selected>Carros Particulares</option>
				...
				<div id="responsive-nav">
					...
					<li><a href="<?php echo base_url('Home/index');?>">Home</a></li>
						...
						<li class="active"><a href="#">Carros</a>
							<ul>
								<li><a href="<?php echo base_url('Home/store_particulares');?>">Carros Particulares</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Carros Particulares <?=count($car);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									<a href="<?php echo base_url('Home/particular_car_info/'.$car->part_id);?>">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="<?php echo base_url('Home/particular_car_info/'.$car->part_id);?>"><?=word_limiter($car->part_title,3);?></a></h3>
