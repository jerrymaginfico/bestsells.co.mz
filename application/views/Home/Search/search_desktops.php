				...
				<h6 style="font-size:16px;;color:#fff;">Procurar</h6>
				 ...
				 <li>
						<select name="listing_items" id="listing_items">
								...
								<option value="desktop" selected>Computadores de Mesa</option>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Computadores de Mesa <?=count($desktop);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							<!-- product -->
							<?php if($desktop):?>
									<?php foreach($desktop as $desk): ?>
							<div class="col-md-3 col-xs-6">
								
								<div class="product">
									<a href="<?php echo base_url('Home/desktop_info/'.$desk->desk_id);?>">
									<div class="product-img">
										<?php if($desk->image_one == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive" style="height: 170px;">
										<?php else: ?>
										<img src="<?=base_url().'EletronicImages/'.$desk->image_one;?>" class="responsive-img" style="height: 170px;">
										<?php endif;?>
									</div>
									<div class="product-body">
										<p class="product-category"><?=$desk->categoria?></p>
										<h3 class="product-name"><a href="<?php echo base_url('Home/desktop_info/'.$desk->desk_id);?>"><?=word_limiter($desk->desk_title,3);?></a></h3>
										<h4 class="product-price"><?=number_format($desk->product_price);?></h4>
									</div>
								</a>
								</div>
