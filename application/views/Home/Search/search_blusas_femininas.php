				...
				<h6 style="font-size:16px;;color:#fff;">Procurar</h6>
				 ...
				 <li>
						<select name="listing_items" id="listing_items">
								...
								<option value="blusas femeninas" selected>Blusas & Camisetes Femeninas</option>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Camisas, Camisetes & Blusas Femininas <?=count($woman);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									<a href="<?php echo base_url('Home/blusa_feminina_info/'.$woman->wshirt_id);?>">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="<?php echo base_url('Home/blusa_feminina_info/'.$woman->wshirt_id);?>"><?=word_limiter($woman->wshirt_title,3);?></a></h3>
