				...
				<h6 style="font-size:16px;;color:#fff;">Procurar</h6>
				 ...
				 <li>
						<select name="listing_items" id="listing_items">
								...
								<option value="calcados masculinos" selected>Calçados Masculinos</option>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Calçados Masculinos <?=count($man);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="<?php echo base_url('Home/calcado_masculina_info/'.$man->mfoot_id);?>"><?=word_limiter($man->shirt_title,3);?></a></h3>
