				...
				<h6 style="font-size:16px;;color:#fff;">Procurar</h6>
				 ...
				 <li>
						<select name="listing_items" id="listing_items">
								...
								<option value="carros de carga" selected>Carros de Carga / Pesados</option>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Carros de Transporte de Carga <?=count($car);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									<a href="<?php echo base_url('Home/cargo_car_info/'.$car->pes_id);?>">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="<?php echo base_url('Home/cargo_car_info/'.$car->pes_id);?>"><?=word_limiter($car->pes_title,3);?></a></h3>
