				...
				<h6 style="font-size:16px;;color:#fff;">Procurar</h6>
				 ...
				 <li>
						<select name="listing_items" id="listing_items">
								...
								<option value="calcados femeninos" selected>Calçados Femeninos</option>
						</select>
					...
					<li><a href="<?php echo base_url('Home/index');?>">Home</a></li>
						...
						<li class="active"><a href="#">Moda Feminina</a>
							<ul>
								...
								<li><a href="<?php echo base_url('Home/store_women_acessories');?>">Acessórios Femininos</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Calçados Femininos <?=count($woman);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							<!-- product -->
							<?php if($woman):?>
									<?php foreach($woman as $woman): ?>
							<div class="col-md-3 col-xs-6">
								
								<div class="product">
									<a href="<?php echo base_url('Home/calcado_feminino_info/'.$woman->wfoot_id);?>">
									<div class="product-img">
										<?php if($woman->image_one == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive" style="height: 170px;">
										<?php else: ?>
										<img src="<?=base_url().'WomenImages/'.$woman->image_one;?>" class="responsive-img" style="height: 170px;">
										<?php endif;?>
									</div>
									<div class="product-body">
										<p class="product-category"><?=$woman->categoria?></p>
										<h3 class="product-name"><a href="<?php echo base_url('Home/calcado_feminino_info/'.$woman->wfoot_id);?>"><?=word_limiter($woman->mfoot_title,3);?></a></h3>
										<h4 class="product-price"><?=number_format($woman->product_price);?></h4>
									</div>
								</a>
								</div>
