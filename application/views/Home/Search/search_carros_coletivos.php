				...
				<h6 style="font-size:16px;;color:#fff;">Procurar</h6>
				 ...
				 <li>
						<select name="listing_items" id="listing_items">
								...
								<option value="semi colectivos" selected>Carros Semi-Colectivos</option>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Carros de Transporte Publico <?=count($car);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									<a href="<?php echo base_url('Home/bus_car_info/'.$car->col_id);?>">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="<?php echo base_url('Home/bus_car_info/'.$car->col_id);?>"><?=word_limiter($car->col_title,3);?></a></h3>
