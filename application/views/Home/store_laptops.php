...
<html lang="en">
	<head>
		...
		<title>BestSellS | Todos Laptop's</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Laptops <?=count($results);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							<!-- product -->
							<?php if($results):?>
									<?php foreach($results as $lap): ?>
							<div class="col-md-3 col-xs-6">
								
								<div class="product">
									<a href="<?php echo base_url('Home/laptop_info/'.$lap->lap_id);?>">
									<div class="product-img">
										<?php if($lap->image_one == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive" style="height: 170px;">
										<?php else: ?>
										<img src="<?=base_url().'EletronicImages/'.$lap->image_one;?>" class="responsive-img" style="height: 170px;">
										<?php endif;?>
									</div>
									<div class="product-body">
										<p class="product-category"><?=$lap->categoria?></p>
										<h3 class="product-name"><a href="<?php echo base_url('Home/laptop_info/'.$lap->lap_id);?>"><?=word_limiter($lap->lap_title,3);?></a></h3>
										<h4 class="product-price"><?=number_format($lap->product_price);?></h4>
									</div>
								</a>
								</div>
