...
<html lang="en">
	<head>
		...
		<title>BestSellS | Todas Bicicletas</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Bicicletas <?=count($results);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									<a href="<?php echo base_url('Home/bic_info/'.$car->bic_id);?>">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="<?php echo base_url('Home/bic_info/'.$car->bic_id);?>"><?=word_limiter($car->bic_title,3);?></a></h3>
