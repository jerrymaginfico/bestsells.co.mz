...
<html lang="en">
	<head>
		...
		<title>BestSellS | Todos Acessórios Masculinos</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Acessórios Masculinos <?=count($results);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									<a href="<?php echo base_url('Home/men_acessory_info/'.$man->ac_id);?>">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="<?php echo base_url('Home/men_acessory_info/'.$man->ac_id);?>"><?=word_limiter($man->ac_title,3);?></a></h3>
