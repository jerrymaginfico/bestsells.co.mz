...
<html lang="en">
	<head>
		...
		<title>BestSellS | Todos Televisores</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Televisores <?=count($results);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							<!-- product -->
							<?php if($results):?>
									<?php foreach($results as $tv): ?>
							<div class="col-md-3 col-xs-6">
								
								<div class="product">
									<a href="<?php echo base_url('Home/tv_info/'.$tv->tv_id);?>">
									<div class="product-img">
										<?php if($tv->image_one == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive" style="height: 170px;">
										<?php else: ?>
										<img src="<?=base_url().'DomesticImages/'.$tv->image_one;?>" class="responsive-img" style="height: 170px;">
										<?php endif;?>
									</div>
									<div class="product-body">
										<p class="product-category"><?=$tv->tv_categoria?></p>
										<h3 class="product-name"><a href="<?php echo base_url('Home/tv_info/'.$tv->tv_id);?>"><?=word_limiter($tv->tv_title,3);?></a></h3>
										<h4 class="product-price"><?=number_format($tv->product_price);?></h4>
									</div>
								</a>
								</div>
