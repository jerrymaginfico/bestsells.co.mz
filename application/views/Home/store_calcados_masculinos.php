...
<html lang="en">
	<head>
		...
		<title>BestSellS | Todas Calçados Masculinos</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Calças Masculinas <?=count($results);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									<a href="<?php echo base_url('Home/calcado_masculina_info/'.$man->mfoot_id);?>">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="<?php echo base_url('Home/calcado_masculina_info/'.$man->mfoot_id);?>"><?=word_limiter($man->mfoot_title,3);?></a></h3>
