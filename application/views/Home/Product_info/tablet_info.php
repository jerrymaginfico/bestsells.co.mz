...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$eletro->tab_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#"><?=$eletro->categoria?></a></li>
						<li><a href="#">Tablet's</a></li>
						<li><a href="#"><?=$eletro->tab_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							<div class="product-preview">
									<?php if($eletro->image_one == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'EletronicImages/'.$eletro->image_one;?>" class="responsive-img">
									<?php endif;?>
							</div>

							<div class="product-preview">
									<?php if($eletro->image_two == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'EletronicImages/'.$eletro->image_two;?>" class="responsive-img">
									<?php endif;?>
							</div>

							<div class="product-preview">
									<?php if($eletro->image_three == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'EletronicImages/'.$eletro->image_three;?>" class="responsive-img">
									<?php endif;?>
							</div>

							<div class="product-preview">
									<?php if($eletro->image_four == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'EletronicImages/'.$eletro->image_four;?>" class="responsive-img">
									<?php endif;?>
							</div>
						</div>
					</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$eletro->tab_title;?></h2>
							<div>
								<h3 class="product-price"><?=number_format($eletro->product_price);?></h3>
							</div>
						<table class="table">
								<tr>
									<td>
										<h6><?php echo get_phrase('Marca');?></h6>
									</td>
									<td>
										<?=$eletro->mobile_brand;?>
									</td>
								...
								<tr>
									<td>
										<h6><?php echo get_phrase('Modelo');?></h6>
									</td>
									<td>
										<?=$eletro->tab_modelo;?>
									</td>
								...
								<tr>
									<td><h6><?php echo get_phrase('Tipo de SIM');?></h6></td>
									<td><?=$eletro->tab_cards;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Processador');?></h6></td>
									<td><?=$eletro->tab_processor;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Memória RAM');?></h6></td>
									<td><?=$eletro->tab_ram;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Memória Interna');?></h6></td>
									<td><?=$eletro->tab_storage;?></td>
								</tr>
                                <tr>
									<td><h6><?php echo get_phrase('Bateria');?></h6></td>
									<td><?=$eletro->tab_battery_size;?></td>
								</tr>
                                <tr>
									<td><h6><?php echo get_phrase('Camera');?></h6></td>
									<td><?=$eletro->tab_camera;?></td>
								</tr>							
							</table>
							<br>
							...
							<table class="table">
								...
								<tr>
									...
									<td><?=$eletro->vend_contato1;?> / <?=$eletro->vend_contato2;?></td>
								</tr>
							</table>
