...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$woman->wshirt_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#">Blusas, Camisas & Camisetes Femininas</a></li>
						<li><a href="#"><?=$woman->wshirt_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$woman->wshirt_title;?></h2>
							<div>
