...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$car->moto_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#">Carros & Veiculos</a></li>
						<li><a href="#"><?=$car->categoria;?></a></li>
						<li><a href="#"><?=$car->moto_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$car->moto_title;?></h2>
							<div>
						...
						<table class="table">
								...
								<tr>
									...
									<td><?=$car->moto_quilometragem;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Combustivel');?></h6></td>
									<td><?=$car->moto_combustivel;?></td>
								</tr>
								<tr>
