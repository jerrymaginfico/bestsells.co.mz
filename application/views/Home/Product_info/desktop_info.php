...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$eletro->desk_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#">Desktop's / Computadores de Mesa</a></li>
						<li><a href="#"><?=$eletro->desk_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$eletro->desk_title;?></h2>
							<div>
						...
						<table class="table">
								...
								<tr>
									<td>
										<h6><?php echo get_phrase('Sistema Operativo');?></h6>
									</td>
									<td>
										<?=$eletro->desk_so;?>
									</td>
								...
								<tr>
									...
									<td><?=$eletro->desk_processor;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Capacidade do HDD');?></h6></td>
									<td><?=$eletro->desk_hdd;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Memória RAM');?></h6></td>
									<td><?=$eletro->desk_ram;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Monitor?');?></h6></td>
									<td><?=$eletro->desk_monitor;?></td>
								</tr>								
							</table>
							<br>
