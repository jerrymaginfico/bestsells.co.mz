...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$car->col_title;?></title>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="#">Carros</a>
							<ul>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#"><?=$car->car_categoria;?></a></li>
						<li><a href="#">Carros Colectivos</a></li>
						<li><a href="#"><?=$car->col_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
						...
						<div id="product-main-img">
							<div class="product-preview">
									<?php if($car->image_one == ""):?>
										...
										<?php else: ?>
										<img src="<?=base_url().'CarrsImages/'.$car->image_one;?>" class="responsive-img">
									<?php endif;?>
							</div>

							<div class="product-preview">
									<?php if($car->image_two == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'CarrsImages/'.$car->image_two;?>" class="responsive-img">
									<?php endif;?>
							</div>

							<div class="product-preview">
									<?php if($car->image_three == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'CarrsImages/'.$car->image_three;?>" class="responsive-img">
									<?php endif;?>
							</div>

							<div class="product-preview">
									<?php if($car->image_four == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'CarrsImages/'.$car->image_four;?>" class="responsive-img">
									<?php endif;?>
							</div>
						</div>
					</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$car->col_title;?></h2>
							<div>
								<h3 class="product-price"><?=number_format($car->product_price);?></h3>
							</div>
						<table class="table">
								<tr>
									<td>
								...
								<tr>
									<td><h6><?php echo get_phrase('Quilometragem');?></h6></td>
									<td><?=$car->col_quilometragem;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Combustivel');?></h6></td>
									<td><?=$car->col_combustivel;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Ano');?></h6></td>
									<td><?=$car->col_ano;?></td>
								</tr>
                                <tr>
									<td><h6><?php echo get_phrase('Transmissão');?></h6></td>
									<td><?=$car->col_transmissao;?></td>
								</tr>
                                <tr>
									<td><h6><?php echo get_phrase('Tipo de Carro');?></h6></td>
									<td><?=$car->col_tipoCarro;?></td>
								</tr>								
							</table>
							<br>
							...
							<table class="table">
								...
								<tr>
									...
									<td><?=$car->vend_contato1;?> / <?=$car->vend_contato2;?></td>
								</tr>
							</table>
