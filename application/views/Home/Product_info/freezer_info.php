...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$domestic->freeze_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#"><?=$domestic->freeze_categoria?></a></li>
						<li><a href="#">Eletrodomésticos</a></li>
						<li><a href="#"><?=$domestic->freeze_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$domestic->freeze_title;?></h2>
							<div>
