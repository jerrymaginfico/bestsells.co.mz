...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$domestic->ac_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#"><?=$domestic->categoria;?></a></li>
						<li><a href="#">Eletrodomésticos</a></li>
						<li><a href="#"><?=$domestic->ac_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$domestic->ac_title;?></h2>
							<div>
