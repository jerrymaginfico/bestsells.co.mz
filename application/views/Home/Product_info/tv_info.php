...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$domestic->tv_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#"><?=$domestic->tv_categoria;?></a></li>
						<li><a href="#">Eletrodomésticos</a></li>
						<li><a href="#"><?=$domestic->tv_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$domestic->tv_title;?></h2>
							<div>
						...
						<table class="table">
                                ...
                                <tr>
									<td>
										<h6><?php echo get_phrase('Tamanho da tela');?></h6>
									</td>
									<td>
										<?=$domestic->tv_size;?>
									</td>
