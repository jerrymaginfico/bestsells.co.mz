...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$man->calc_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#">Calças Masculinas</a></li>
						<li><a href="#"><?=$man->calc_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$man->calc_title;?></h2>
							<div>
