...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$man->shirt_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#"><?=$man->categoria;?></a></li>
						<li><a href="#">Camisas & Camisetes Masculinas</a></li>
						<li><a href="#"><?=$man->shirt_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
						...
						<div id="product-main-img">
							<div class="product-preview">
									<?php if($man->image_one == ""):?>
										...
										<?php else: ?>
										<img src="<?=base_url().'MenImages/'.$man->image_one;?>" class="responsive-img">
									<?php endif;?>
							</div>

							<div class="product-preview">
									<?php if($man->image_two == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'MenImages/'.$man->image_two;?>" class="responsive-img">
									<?php endif;?>
							</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$man->shirt_title;?></h2>
							<div>
								<h3 class="product-price"><?=number_format($man->product_price);?></h3>
							</div>
						<table class="table">
								<tr>
									<td>
							...
							<table class="table">
								...
								<tr>
									...
									<td><?=$man->vend_contato1;?> / <?=$man->vend_contato2;?></td>
								</tr>
							</table>
