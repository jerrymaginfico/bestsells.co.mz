...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$domestic->fog_title;?></title>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="#">Eletrodomésticos</a>
							<ul>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#"><?=$domestic->fog_categoria?></a></li>
						<li><a href="#">Eletrodomésticos</a></li>
						<li><a href="#"><?=$domestic->fog_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							<div class="product-preview">
									<?php if($domestic->image_one == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'DomesticImages/'.$domestic->image_one;?>" class="responsive-img">
									<?php endif;?>
							</div>

							<div class="product-preview">
									<?php if($domestic->image_two == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'DomesticImages/'.$domestic->image_two;?>" class="responsive-img">
									<?php endif;?>
							</div>

                            <div class="product-preview">
									<?php if($domestic->image_three == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'DomesticImages/'.$domestic->image_three;?>" class="responsive-img">
									<?php endif;?>
							</div>

                            <div class="product-preview">
									<?php if($domestic->image_four == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive">
										<?php else: ?>
										<img src="<?=base_url().'DomesticImages/'.$domestic->image_four;?>" class="responsive-img">
									<?php endif;?>
							</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$domestic->fog_title;?></h2>
							<div>
								<h3 class="product-price"><?=number_format($domestic->product_price);?></h3>
							</div>
						<table class="table">
								<tr>
									<td>
										<h6><?php echo get_phrase('Tipo');?></h6>
									</td>
									<td>
										<?=$domestic->fog_type;?>
									</td>
                                ...
                                <tr>
									<td>
										<h6><?php echo get_phrase('Nº de Bocas');?></h6>
									</td>
									<td>
										<?=$domestic->fog_number;?>
									</td>
							...
							<table class="table">
								<tr>
									...
									<td><?=$domestic->nome_completo;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Email');?></h6></td>
									<td><?=$domestic->email;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Contactos');?></h6></td>
									<td><?=$domestic->vend_contato1;?> / <?=$domestic->vend_contato2;?></td>
								</tr>
							</table>
