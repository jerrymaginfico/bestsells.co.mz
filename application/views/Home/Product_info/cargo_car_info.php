...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$car->pes_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#">Carros de Carga / Pesados</a></li>
						<li><a href="#"><?=$car->pes_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$car->pes_title;?></h2>
							<div>
						...
						<table class="table">
								...
								<tr>
									...
									<td><?=$car->pes_quilometragem;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Combustivel');?></h6></td>
									<td><?=$car->pes_combustivel;?></td>
								</tr>
								<tr>
