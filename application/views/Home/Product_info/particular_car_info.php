...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$car->part_title;?></title>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$car->part_title;?></h2>
							<div>
						...
						<table class="table">
								...
								<tr>
									...
									<td><?=$car->part_quilometragem;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Combustivel');?></h6></td>
									<td><?=$car->part_combustivel;?></td>
								</tr>
								<tr>
                                ...
                                <tr>
									...
									<td><?=$car->part_transmissao;?></td>
								</tr>
                                <tr>
									<td><h6><?php echo get_phrase('Tipo de Carro');?></h6></td>
									<td><?=$car->part_tipocarro;?></td>
								</tr>								
							</table>
							<br>
