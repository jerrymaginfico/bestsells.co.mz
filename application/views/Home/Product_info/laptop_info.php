...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$eletro->lap_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#"><?=$eletro->lap_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$eletro->lap_title;?></h2>
							<div>
						...
						<table class="table">
								...
								<tr>
									...
									<td><?=$eletro->lap_processor;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Capacidade do HDD');?></h6></td>
									<td><?=$eletro->lap_hdd;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Memória RAM');?></h6></td>
									<td><?=$eletro->lap_ram;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Tamanho da Tela');?></h6></td>
									<td><?=$eletro->lap_size;?></td>
								</tr>								
							</table>
							<br>
