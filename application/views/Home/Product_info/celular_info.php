...
<html lang="en">
	<head>
		...
		<title>BestSellS | <?=$eletro->cel_title;?></title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<li><a href="#"><?=$eletro->cel_title;?></a></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?=$eletro->cel_title;?></h2>
							<div>
						...
						<table class="table">
								...
								<tr>
									<td><h6><?php echo get_phrase('Cor');?></h6></td>
									<td><?=$eletro->cel_cor;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Tipo de SIM');?></h6></td>
									<td><?=$eletro->cel_cards;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Memória RAM');?></h6></td>
									<td><?=$eletro->cel_ram;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Memória Interna');?></h6></td>
									<td><?=$eletro->cel_storage;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Bateria');?></h6></td>
									<td><?=$eletro->cel_battery_size;?></td>
								</tr>
								<tr>
									<td><h6><?php echo get_phrase('Cameras');?></h6></td>
									<td><?=$eletro->cel_camera;?></td>
								</tr>
							</table>
							<br>
