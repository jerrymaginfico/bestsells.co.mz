...
<html lang="en">
	<head>
		...
		<title>BestSellS | Todas Calças Masculinas</title>
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									<a href="<?php echo base_url('Home/calca_masculina_info/'.$man->trous_id);?>">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="<?php echo base_url('Home/calca_masculina_info/'.$man->trous_id);?>"><?=word_limiter($man->calc_title,3);?></a></h3>
