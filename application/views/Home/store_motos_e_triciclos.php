...
<html lang="en">
	<head>
		...
		<title>BestSellS | Todas Motos & Triciclos</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Motos & Triciclos <?=count($results);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									<a href="<?php echo base_url('Home/moto_info/'.$car->moto_id);?>">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="<?php echo base_url('Home/moto_info/'.$car->moto_id);?>"><?=word_limiter($car->moto_title,3);?></a></h3>
