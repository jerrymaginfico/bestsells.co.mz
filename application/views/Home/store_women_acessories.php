...
<html lang="en">
	<head>
		...
		<title>BestSellS | Todos Acessórios Femininos</title>
					...
					<li><a href="<?php echo base_url('Home/index');?>">Home</a></li>
						...
						<li class="active"><a href="#">Moda Feminina</a>
							<ul>
								...
								<li><a href="#">Acessórios Femininos</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Acessórios Femininos <?=count($results);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									<a href="<?php echo base_url('Home/women_acessory_info/'.$woman->acc_wid);?>">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="<?php echo base_url('Home/women_acessory_info/'.$woman->acc_wid);?>"><?=word_limiter($woman->ac_title,3);?></a></h3>
