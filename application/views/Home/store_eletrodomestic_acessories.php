...
<html lang="en">
	<head>
		...
		<title>BestSellS | Todos Acessórios Eletrodomésticos</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Acessórios Eletrodomésticos <?=count($results);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 col-xs-6">
								...
								<div class="product">
									<a href="<?php echo base_url('Home/eletrodomestic_acessory_info/'.$acc->ac_id);?>">
									<div class="product-img">
										<?php if($acc->image_one == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive" style="height: 170px;">
										<?php else: ?>
										<img src="<?=base_url().'DomesticImages/'.$acc->image_one;?>" class="responsive-img" style="height: 170px;">
										<?php endif;?>
									</div>
									<div class="product-body">
										<p class="product-category"><?=$acc->categoria?></p>
										<h3 class="product-name"><a href="<?php echo base_url('Home/eletrodomestic_acessory_info/'.$acc->ac_id);?>"><?=word_limiter($acc->ac_title,3);?></a></h3>
										<h4 class="product-price"><?=number_format($acc->product_price);?></h4>
									</div>
								</a>
								</div>
