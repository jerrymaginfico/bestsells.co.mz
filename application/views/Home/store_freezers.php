...
<html lang="en">
	<head>
		...
		<title>BestSellS | Geleiras, Congeladores e Frigorificos</title>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active">Congeladores & Geleiras <?=count($results);?> nesta pagina</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div id="store" class="col-md-12">
						...
						<div class="row">
							<!-- product -->
							<?php if($results):?>
									<?php foreach($results as $freezer): ?>
							<div class="col-md-3 col-xs-6">
								
								<div class="product">
									<a href="<?php echo base_url('Home/freezer_info/'.$freezer->freeze_id);?>">
									<div class="product-img">
										<?php if($freezer->image_one == ""):?>
										<img src="<?=base_url('bestsells/img/bestlogo.png');?>" class="img-responsive" style="height: 170px;">
										<?php else: ?>
										<img src="<?=base_url().'DomesticImages/'.$freezer->image_one;?>" class="responsive-img" style="height: 170px;">
										<?php endif;?>
									</div>
									<div class="product-body">
										<p class="product-category"><?=$freezer->freeze_categoria?></p>
										<h3 class="product-name"><a href="<?php echo base_url('Home/freezer_info/'.$freezer->freeze_id);?>"><?=word_limiter($freezer->freeze_title,3);?></a></h3>
										<h4 class="product-price"><?=number_format($freezer->product_price);?></h4>
									</div>
								</a>
								</div>
